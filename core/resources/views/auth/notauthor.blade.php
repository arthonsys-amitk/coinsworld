        ...
        <div class="row">
		  ...
		  <div class="col-md-6">
			 <div class="panel panel-primary">
			  ...
			  <div class="panel-body">
				<form class="req_call_frm" action="{{route('emailverify') }}" method="POST">
				  {{csrf_field()}}
				  <div class="form-group unauth_form">
		  ...
		  <div class="col-md-6">
			 <div class="panel panel-primary">
			  <div class="panel-heading">Verify Code</div>
			  <div class="panel-body">
				<form class="req_call_frm" action="{{route('smsverify') }}" method="POST">
				  {{csrf_field()}}
				  <div class="form-group">
					<input type="text"  name="code" placeholder="Enter Verification Code">
				  </div>
